...
const testMode = process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'test'  // TODO: remove development check once you have proper .env and database of your own.
